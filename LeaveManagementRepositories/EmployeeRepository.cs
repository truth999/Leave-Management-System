...
namespace LeaveManagementRepository
{
    public class EmployeeRepository
    {
        ...
        public RegisterModel EmployeeDetails(string username)
        {
            ...
            con.Open();
            OracleCommand cmd = new OracleCommand("SELECT EMP_ID,EMP_NAME,EMAIL,MOBILE,GENDER,DATEOFBIRTH,ADDRESS,CITY,EMP_STATE FROM REGISTERTABLE WHERE USERNAME = '" + username + "'", con);
        ...
        public void UpdateProfileDetails(ProfileModel profileModel)
        {
            ...
            cmd.Parameters.Add("E_ID", profileModel.Empid);
